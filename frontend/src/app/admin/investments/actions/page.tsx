  ...
  return (
    <div className="space-y-6 max-w-7xl mx-auto p-4 sm:p-6 lg:p-8">
      ...
      <Link
        ...
        className="inline-flex items-center space-x-1.5 text-xs font-black text-[#01281a] hover:text-[#023c28] transition-colors"
      >
        <ArrowLeft className="w-4 h-4 text-[#d4af37]" />
        <span>Back to Investments</span>
      </Link>

      {/* Dark Emerald & Gold Luxury Banner Header */}
      <div className="bg-gradient-to-r from-[#01281a] via-[#011f15] to-[#00170f] border border-[#d4af37]/35 rounded-2xl p-5 sm:p-6 text-white shadow-xl">
        <div className="flex items-start space-x-3.5">
          ...
          <div className="space-y-1">
            <h1 className="text-lg sm:text-xl font-black tracking-tight text-white">User Investment Actions</h1>
            <p className="text-xs text-slate-300 font-semibold">Approve, reject, and manage all user investment records.</p>
          </div>
        </div>
      </div>
      ...
      <div className="grid grid-cols-3 gap-3.5">
        <div className="bg-gradient-to-br from-[#2a1a03] to-[#140b01] border border-amber-500/40 rounded-2xl p-3.5 sm:p-4 text-center shadow-lg text-white">
          <div className="text-2xl font-black text-amber-100 font-mono">{pendingCount}</div>
          <div className="text-[10px] font-black text-amber-300 uppercase tracking-widest">Pending</div>
        </div>
        <div className="bg-gradient-to-br from-[#023322] to-[#011a12] border border-[#d4af37]/35 rounded-2xl p-3.5 sm:p-4 text-center shadow-lg text-white">
          <div className="text-2xl font-black text-white font-mono">{approvedCount}</div>
          <div className="text-[10px] font-black text-amber-200 uppercase tracking-widest">Approved</div>
        </div>
      ...
      <div className="bg-white border border-slate-200 rounded-2xl p-5 sm:p-6 space-y-5 shadow-sm">
        <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-3 border-b border-slate-100 pb-4">
          <div className="flex items-center space-x-3">
            ...
            <h2 className="text-base sm:text-lg font-black text-slate-900">All Investments</h2>
          </div>
