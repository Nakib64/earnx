...
import { Phone, Lock, ArrowRight, ShieldCheck, AlertCircle, Eye, EyeOff, LogIn } from 'lucide-react';
      ...
      <div className="bg-white border border-slate-200/90 rounded-2xl p-4 sm:p-5 shadow-sm">
        <div className="text-center space-y-3">
          <p className="text-xs font-extrabold text-slate-500">
            ...
            <Link href="/register" className="text-primary hover:text-[#044D2F] transition-colors">
              Register now
            </Link>
          </p>
